...
import torch
from nlp_utils.dataset import DoubleSentenceTextDataset, create_double_sentence_datafile_for_mlm
from transformers import Trainer, TrainingArguments
from collections import defaultdict
from nezha.modeling_nezha import BertForMaskedLM, BertConfig
...
def train():
    ...
    dataset = DoubleSentenceTextDataset(
        tokenizer=tokenizer,
